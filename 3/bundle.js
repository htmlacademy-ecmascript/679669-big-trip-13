...
/* harmony import */ var _view_waypoint__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./view/waypoint */ "./src/view/waypoint.js");
...
renderTemplate(tripMainElement, Object(_view_trip_info__WEBPACK_IMPORTED_MODULE_0__["createTripInfoTemplate"])(), `beforeend`);

const tripControlsElement = tripMainElement.querySelector(`.trip-controls`);
const tripControlsFirstChildHeader = tripControlsElement.querySelector(`h2`);
// 1- меню 2- фильтры
renderTemplate(tripControlsFirstChildHeader, Object(_view_menu__WEBPACK_IMPORTED_MODULE_1__["createMenuTemplate"])(), `afterend`); // меню
renderTemplate(tripControlsElement, Object(_view_filter__WEBPACK_IMPORTED_MODULE_2__["createFilterTemplate"])(), `beforeend`);// фильтры

const tripEventsElement = document.querySelector(`.trip-events`);
// 1- сортировка 2- контент
renderTemplate(tripEventsElement, Object(_view_sorting__WEBPACK_IMPORTED_MODULE_3__["createSortingTemplate"])(), `beforeend`);
renderTemplate(tripEventsElement, Object(_view_waypoint__WEBPACK_IMPORTED_MODULE_4__["createWaypointTemplate"])(), `beforeend`);
