...
const addEventToList = (eventListElement, event) => {
  ...
  Object(_utils__WEBPACK_IMPORTED_MODULE_11__["renderElement"])(eventListElement, tripEvent.getElement());
};
...
Object(_utils__WEBPACK_IMPORTED_MODULE_11__["renderElement"])(tripMainElement, new _view_trip_info_container__WEBPACK_IMPORTED_MODULE_6__["default"]().getElement(), `prepend`);
const tripInfoContainer = tripMainElement.querySelector(`.trip-info`);

Object(_utils__WEBPACK_IMPORTED_MODULE_11__["renderElement"])(tripInfoContainer, new _view_trip_info_route__WEBPACK_IMPORTED_MODULE_7__["default"](events).getElement());
Object(_utils__WEBPACK_IMPORTED_MODULE_11__["renderElement"])(tripInfoContainer, new _view_header_trip_cost__WEBPACK_IMPORTED_MODULE_1__["default"](events).getElement());


Object(_utils__WEBPACK_IMPORTED_MODULE_11__["renderElement"])(tripControlsFirstHeaderElement, new _view_header_nav_menu__WEBPACK_IMPORTED_MODULE_2__["default"]().getElement(), `insertAfter`);
Object(_utils__WEBPACK_IMPORTED_MODULE_11__["renderElement"])(tripControlsSecondHeaderElement, new _view_header_filters__WEBPACK_IMPORTED_MODULE_3__["default"]().getElement(), `insertAfter`);

// сортировка

Object(_utils__WEBPACK_IMPORTED_MODULE_11__["renderElement"])(tripEventsSection, new _view_trip_sorting__WEBPACK_IMPORTED_MODULE_4__["default"]().getElement());

const tripSortElement = tripEventsSection.querySelector(`.trip-sort`);

Object(_utils__WEBPACK_IMPORTED_MODULE_11__["renderElement"])(tripSortElement, new _view_trip_events_container__WEBPACK_IMPORTED_MODULE_5__["default"]().getElement(), `insertAfter`);
...
const getRandomStartDate = () => {
  const year = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(2021, 2022);
...
const renderAppWithoutEvents = (events, eventsSection) => {
  if (!events[0]) {
    Object(_utils__WEBPACK_IMPORTED_MODULE_0__["renderElement"])(eventsSection, new _without_events__WEBPACK_IMPORTED_MODULE_1__["default"]().getElement());
  }
};
